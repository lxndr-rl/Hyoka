...
const phoneWidth = Platform.OS == 'web' ? Dimensions.get('window').width < 800 ? Dimensions.get('window').width : Dimensions.get('window').width / 2.5 : Dimensions.get('window').width;
    ...
    return (
        <LinearGradient
            ...
            <View style={styles.cardSection}>
                ...
                <Text numberOfLines={1} ellipsizeMode='tail' style={styles.cardTextSection1}>Recuperación</Text>
                <Text numberOfLines={1} ellipsizeMode='tail' style={styles.cardTextSection1}>Total</Text>
            </View>
            <View style={styles.cardSection}>
